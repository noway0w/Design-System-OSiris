<?php
/**
 * CarScan — PHP entry so the platform top bar is always present (nginx: index.php before index.html).
 */
...
if (!is_readable($htmlPath)) {
    ...
    echo 'CarScan index.html missing';
    exit;
}
...
if ($html === false) {
    http_response_code(500);
    header('Content-Type: text/plain; charset=utf-8');
    echo 'Could not read CarScan page';
    exit;
}
